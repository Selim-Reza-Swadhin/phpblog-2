...
<h2 style="margin-left: 50px;"><a href="../index.php">Go Back</a></h2>
...
<div id="login-box">
    ...
    <div class="right-box">
        ...
        <form action="#" method="post">
            ...
            <button class="social twitter"><i class="fa fa-twitter"> <a href="www.twitter.com">Log in with Twitter</a></i></button>
